...
public final class MaiMaiDialogueEditor {
    ...
    public MaiMaiDialogueEditor(ModContainer modContainer, IEventBus modBus) {
        ...
        modBus.addListener(top.rookiestwo.maimai_dialogue_editor.client.EditorDialogueAudio::reloaded);
