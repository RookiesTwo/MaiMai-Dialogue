...
public final class EditorReadyImages implements DialogueImageSource {
    private final Map<ResourceLocation, Image> images = new LinkedHashMap<>();
    public EditorReadyImages(Map<ResourceLocation, Image> source) { source.forEach((id, image) -> images.put(id, image.clone())); }
