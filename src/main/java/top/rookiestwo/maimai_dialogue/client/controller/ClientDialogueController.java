...
public final class ClientDialogueController implements DialogueUiActions {
    ...
    @Nullable
    private DialogueScreenHandle screen;
    private final DialogueScreenHost screenHost;

    public ClientDialogueController(
    ...
    public void onScreenDestroyed(DialogueScreenHandle destroyedScreen) {
        requireClientThread();
    ...
    public DialogueScreenState viewState() {
        ...
        return DialogueScreenState.empty(nextGeneration);
    }
    ...
    private DialogueContentLookup contentLookup() {
        return new DialogueContentLookup() {
            ...
            @Override
            public java.util.Optional<top.rookiestwo.maimai_dialogue.presentation.visual.VisualAssetDefinition>
            visualAsset(ResourceLocation id) {
                return snapshot().visualAssets().find(id);
            }

            @Override
            public java.util.Optional<top.rookiestwo.maimai_dialogue.presentation.scene.SceneDefinition>
    ...
    static void reportDevelopmentError(String message) {
        ClientDiagnostics.report(message);
    }
    ...
    private static DialogueAccessDecision accessDecision(
        ...
        return switch (status) {
            ...
            case DIALOGUE_NOT_FOUND -> DialogueAccessDecision.DIALOGUE_NOT_FOUND;
            case REQUIREMENTS_NOT_MET -> DialogueAccessDecision.REQUIREMENTS_NOT_MET;
            case PROGRESS_UNAVAILABLE -> DialogueAccessDecision.PROGRESS_UNAVAILABLE;
            case INTERNAL_ERROR -> DialogueAccessDecision.INTERNAL_ERROR;
            case SERVER_TRIGGER_ONLY -> DialogueAccessDecision.SERVER_TRIGGER_ONLY;
        };
    }
    ...
    private static OptionCommandDecision optionCommandDecision(
        ...
        return switch (status) {
            ...
            case SOURCE_DIALOGUE_NOT_FOUND -> OptionCommandDecision.SOURCE_DIALOGUE_NOT_FOUND;
            case SOURCE_REQUIREMENTS_NOT_MET -> OptionCommandDecision.SOURCE_REQUIREMENTS_NOT_MET;
            case TARGET_DIALOGUE_NOT_FOUND -> OptionCommandDecision.TARGET_DIALOGUE_NOT_FOUND;
            case TARGET_REQUIREMENTS_NOT_MET -> OptionCommandDecision.TARGET_REQUIREMENTS_NOT_MET;
            case PROGRESS_UNAVAILABLE -> OptionCommandDecision.PROGRESS_UNAVAILABLE;
