...
import top.rookiestwo.maimai_dialogue.client.ui.style.DialogueScrollbarStyle;
import top.rookiestwo.maimai_dialogue.client.ui.style.DialogueTypography;
import top.rookiestwo.maimai_dialogue.client.ui.text.DialogueMarkdown;
...
final class DialogueConfirmationView extends FrameLayout {
    ...
    void applyTheme(ThemeDefinition theme) {
        ...
        DialogueButtonStyle.apply(cancelButton, theme);
        DialogueButtonStyle.apply(confirmButton, theme);
